...
def read_parser():
        ...
        def general_training_args(required_train, optional_train):
        	...
        	group.add_argument('-bw', '--bigwig', type=str, help="Input bigwig file")
        	required_train.add_argument('-o', '--output-dir', type=str, required=True, help="Output dir (path/to/output/dir)")
        	#required_train.add_argument('-d', '--data-type', required=True, type=str, choices=['ATAC', 'DNASE', 'RLOOP'], help="assay type")
        	...
        	optional_train.add_argument('--RLOOP-ref-path', type=str, default=None, help="Path to RLOOP reference motifs (RLOOP.ref.motifs.txt used by default)")
        ...
        #required_qc_parser.add_argument('-d', '--data-type', required=True, type=str, choices=['ATAC', 'DNASE','RLOOP'], help="assay type")
       ...
       # bias model qc arguments
        ...
        #required_bqc_parser.add_argument('-d', '--data-type', required=True, type=str, choices=['ATAC', 'DNASE', 'RLOOP'], help="assay type")
